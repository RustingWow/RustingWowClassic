ALTER TABLE gameobject_types ALTER COLUMN faction DROP DEFAULT;

ALTER TABLE gameobject_types
    ...
    USING (CASE faction
        ...
        WHEN 0 THEN 'NONE'::creature_faction
        ELSE 'NONE'::creature_faction
    END);

ALTER TABLE gameobject_types ALTER COLUMN faction SET DEFAULT 'NONE';
